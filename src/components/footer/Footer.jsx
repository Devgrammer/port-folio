...
const Footer = () => {
  ...
  return (
    <>
      <div className="footer-menu w-[90%] fixed bottom-4 h-24 box-border rounded-lg  flex z-30 justify-between items-center p-2 pb-4 backdrop-blur-sm bg-black/20  hover:cursor-pointer">
        <div
