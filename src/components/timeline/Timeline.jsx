...
const TimelineBox = ({ index, role, start, end, location, id, desc, org }) => {
  ...
  return (
    <div
      ...
      } bottom-[-64px] md:bottom-[-56px] border-0 border-gray-700  box-border w-80  md:w-80 h-32 md:h-28 rounded-md bg-white/50 flex items-center backdrop-blur-xl  transform hover:border-2 hover:border-cyan-600 hover:scale-110 duration-700 hover:cursor-pointer`}
    >
